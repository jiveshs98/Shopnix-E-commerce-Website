...
<aside id="notifications">
  ...
  <div class="js-address-form">
    <form method="POST" action="up_address.php?n=<?= $user['uid'];?>" data-id-address="10" data-refresh-url=>
    ...
    <div class="col-md-6">
          ...
          <select class="form-control form-control-select js-country" name="id_country" required="">
            <option value="" disabled="" selected="">-- please choose --</option>
                          ...
                          <option value="21" selected="">India</option>
                          <option value="21" selected="">china</option>
                          <option value="21" selected="">Japan</option>
                      </select>
    </div>
    ...
    <div class="col-md-3 form-control-comment">
      ...
      <footer class="form-footer clearfix">
        <input type="hidden" name="submitAddress" value="1">
          ...
          <button class="btn btn-primary float-xs-right" type="submit" name="sub">
            Save
          </button>
